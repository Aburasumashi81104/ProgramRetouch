					...
					<div class="card-content">
						<table class="bordered">
							...
							<tbody>
								...
								<%
									for (BuyDataBeans boughtBDB : boughtBDBList) {
								%>

								<tr>
									<td class="center"><a href="UserBuyHistoryDetail?buy_id=<%=boughtBDB.getId()%>" class="btn-floating btn waves-effect waves-light "> <i class="material-icons">details</i></a></td>
									<td class="center"><%=boughtBDB.getFormatDate()%></td>
									<td class="center"><%=boughtBDB.getDeliveryMethodName()%></td>
									<td class="center"><%=boughtBDB.getTotalPrice()%>円</td>
								</tr>
